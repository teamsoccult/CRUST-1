...
save(lattice_bo, file = "lattice_bo")
```
...
save(lattice_tess, file = "lattice_tess")
```
...
save(lattice_mave, file = "lattice_mave")
```
...
save(full_connect_graph, file = "full_connected_graph")
```
...
save(small_world_bo, file = "small_world_bo")
```
...
save(small_world_tess, file = "small_world_tess")
```
...
save(small_world_mave, file = "small_world_mave")
```
