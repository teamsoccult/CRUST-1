...
source(paste0(scriptDir, "/ABM_NN.R")) #TOM cit. network. 
```
...
sigmas <- list(0.8) #0.2 & 0.8 deleted. 
base_sampleSizes <- list(20) #20 
pop_types <- list("Tess")
tMods <- list(13)
...
ABM_NN(replications, turns, models, k, 
