...
replications <- 5 #100 originally, now 2. 
...
```{r}
net_types <- list("TOM", "Lattice", "Small") #"Lattice", "Small", "TOM"
sigmas <- list(0.2, 0.8) #0.2, 0.5, 0.8 
base_sampleSizes <- list(20) #20, 100. 
pop_types <- list("Tess", "Mave") #"Bo", "Mave", "Tess", "All"
tMods <- list(2, 13) #2, 7, 13. 
