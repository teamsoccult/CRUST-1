...
#working directory. 
setwd("E:/data/data_prepped_24-11")
path = "E:/data/data_prepped_24-11"
...
violin_extended_rework <- function(files){
  ...
  #write csv:
  write_csv(df, "violin_extended_colabtest.csv")
  write_csv(df_strat, "violin_extended_strat_colabtest.csv")
