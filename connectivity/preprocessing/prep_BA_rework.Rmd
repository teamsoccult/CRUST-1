...
#check 2:
sum(data[27:40]) #same as number of rows. 
...
data_check <- data_check %>%
  mutate(switch_test = switch_true_changing + switch_true_rejecting)
  
all(data_check$switch_test == data_check$switch_true) #TRUE 
...
getwd()
write.csv(data, "colabtest.csv", row.names = FALSE)
