...
## Parameter output
    ...
    param[[P_XSET]] <- Xset
    param[[P_NETWORK]] <- matrix_g #network 
    param[[P_MODELCOMP]] <- criterion #AIC or BIC
    ...
    write.table(output, file=paste0(outputDir, "/", net_type, "_", pop_type, "_", sigma, "_", criterion, "_", howmany, outputFile),
...
```{r}
#epistemic varying network
sm <- read.csv("data/outputs/output_all.csv", sep = ";")
lat <- read.csv("data/outputs/output_lattice.csv", sep = ";")
sf <- read.csv("data/outputs/output_scale_free.csv", sep = ";")

#small world varying population
sm_tess <- read.csv("data/outputs/small_tess.csv", sep = ";")
sm_bo <- read.csv("data/outputs/small_bo.csv", sep = ";")
sm_mave <- read.csv("data/outputs/small_mave.csv", sep = ";")

#high sigma
sm_ep_s08_AIC <- read.csv("data/outputs/output_sigma_08.csv", sep = ";")
sm_ep_s08_BIC <- read.csv("data/outputs/output_sigma08_BIC.csv", sep = ";")
