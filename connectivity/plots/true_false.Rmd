...
g <- df %>%
  filter(sigma == 0.5, population == "Mave", network == "Small", true_model == 13) %>%
  ...
  labs(y = "Proportion", color = "Proportion of different models", title = "Small-world Mave 0.5 - 13")
