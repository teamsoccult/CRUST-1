...
p_load(igraph, stringr, ggraph, wesanderson, cowplot, caTools, data.table, permute, matrixStats, MCMCpack, tidyverse, gghighlight, ggunchained)
```
...
g <- df %>%
  ...
  geom_smooth(method = "loess", se = F, alpha = 0.1, size = 1, aes(labels = variable)) +
