...
g <- df %>%
  ...
  geom_hline(aes(yintercept = 0.5), color = "red", linetype = "dotted", size = 1) + 
  labs(x = "Studies", y = "Proportion", color = "Proportion of different populations", 
       title = "Proportion of agents at the true model for the different populations",
       subtitle = "Downsampled by a factor 100:1") +
  theme_janco_point()
