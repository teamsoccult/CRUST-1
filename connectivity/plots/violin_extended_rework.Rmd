...
files <- list.files(path = path, pattern="*2019.csv")
...
RR_FUN(df_RR, net_size) #looks terrible. 
...
RR_FUN3(df_RR, population, net_size) #no effect. 
...
RR_FUN3(df_RR, network, net_size) #same. 
...
RR_FUN3(df_RR, sigma, net_size) #nothing. 
...
RR_FUN3(df_RR, true_model, net_size) #nothing. 
...
RR_FUN3(df_RR, colab_cond, net_size) #nothing. 
