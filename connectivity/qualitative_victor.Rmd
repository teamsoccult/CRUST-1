...
## outputs
outputFile <- "output_qualitative_lattice.csv"
...
#loads as "g"
load("connectivity/networks/lattice") #this is the one I have loaded
...
```{r}
qual_data_2_hard_hell <- read.csv("C:/Users/Mikkel/Documents/CRUST-1/data/output_qualitative_2_hard_hell.csv", sep = ";")

naming_2_hard_hell <- colnames(qual_data_2_hard_hell)


melt_qual_data_2_hard_hell <- melt(qual_data_2_hard_hell, id = c(naming_2_hard_hell[1:24], naming_2_hard_hell[39:44]))

colored_plot_qual_hard_hell <- ggplot(melt_qual_data_2_hard_hell, aes(timestep, value, color = variable))+
  geom_point(alpha = 0.01) +
  geom_smooth(alpha = 0.01) +
  geom_hline(aes(yintercept = 0.5), color = "red", linetype = "dashed", size = 1)

colored_plot_qual_hard_hell

plot_grid(colored_plot_qual_less_hell, colored_plot_qual_hard_hell, labels = c("soft", "hard"))
```

```{r}
qual_lattice <- read.csv("C:/Users/Mikkel/Documents/CRUST-1/data/output_qualitative_lattice.csv", sep = ";")

naming_lattice <- colnames(qual_lattice)

melt_lattice <- melt(qual_lattice, id = c(naming_lattice[1:24], naming_lattice[39:44]))

colored_plot_qual_lattice <- ggplot(melt_lattice, aes(timestep, value, color = variable))+
  geom_point(alpha = 0.01) +
  geom_smooth(alpha = 0.01) +
  geom_hline(aes(yintercept = 0.5), color = "red", linetype = "dashed", size = 1)

colored_plot_qual_lattice
