...
total_errors %>%
  ...
  kable_styling(bootstrap_options = c("striped",
                                      ...
                                      full_width = F,
                                      align = "left")) %>%
  add_header_above(c("Percentage of sampling same model for Populations" = 2))  
...
qualitative_errors %>%
  ...
  kable_styling(bootstrap_options = c("striped",
                                      full_width = F,
                                      align = "left")) %>%
  add_header_above(c("Global models from which Bo & Tess resample the same model" = 3)) 
...
sampling %>%
  ...
  kable_styling(bootstrap_options = c("striped",
                                      full_width = F,
                                      align = "left")) %>%
  add_header_above(c("Tess sampling strategy" = 4)) 
