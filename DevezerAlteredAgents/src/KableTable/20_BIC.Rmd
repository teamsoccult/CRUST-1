...
RR_MED <- medianFX(RR_20_BIC, population, RR_median)
STICK_MED <- medianFX(STICK_20_BIC, population, stickiness_median)
TAT_MED <- medianFX(TAT_20_BIC, population, TAT_median)

#first passage (differs, so hard coded)
FPTT_MED <- FPTT_20_BIC %>%
...
RR_IQR <- medianFX(RR_20_BIC, population, RR_IQR)
STICK_IQR <- medianFX(STICK_20_BIC, population, stickiness_IQR)
TAT_IQR <- medianFX(TAT_20_BIC, population, TAT_IQR)



#first passage (differs, so hard coded)
FPTT_IQR <- FPTT_20_BIC %>%
