...
```{r}
#reading data 
temp = list.files(pattern="*Devezer")
list2env(
...
RR_MED <- medianFX(RR_Devezer, population, RR_median)
STICK_MED <- medianFX(STICK_Devezer, population, stickiness_median)
TAT_MED <- medianFX(TAT_Devezer, population, TAT_median)

#first passage (differs, so hard coded)
FPTT_MED <- FPTT_Devezer %>%
...
RR_IQR <- medianFX(RR_Devezer, population, RR_IQR)
STICK_IQR <- medianFX(STICK_Devezer, population, stickiness_IQR)
TAT_IQR <- medianFX(TAT_Devezer, population, TAT_IQR)



#first passage (differs, so hard coded)
FPTT_IQR <- FPTT_Devezer %>%
