...
```{r}
setwd("~/CRUST-1/MetascienceBA/CitationNetworks/Prospect Theory 2018-2019")
...
#save the file
saveRDS(g, "~/CRUST-1/citation_network/prospect_theory.rds")
...
closeness(g) #Cloness centrality measures how many steps is required to access every other vertex from a given vertex.
assortativity_degree(g, directed = F) #how likely are similar vertices to connect to each other? negative if no, positive if yes
