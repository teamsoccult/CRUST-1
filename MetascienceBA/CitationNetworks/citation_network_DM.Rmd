...
```{r}
setwd("~/CRUST-1/citation_network/Decision Making")

temp <- list.files(pattern="*bib")

#NOTE: For the current code to work, you can only have 4 files per search. This is usually more than enough, as we have 2000 papers from 2014-2019
...
```{r}
#limiting publications from within the last 5 years
...
data_new_1 <- distinct(data_new, original, `first_cited[[i]]`, .keep_all = T) 
