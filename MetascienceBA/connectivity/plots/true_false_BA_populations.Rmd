...
df_new <- read.csv("populations.csv", sep = ",")
...
g1 <- melt_new %>%
  filter(sigma == sigma_p, population == population_p, network == network_p, true_model == true_model_p, sample_size == sample_size_p, net_size == net_size_p) %>%
