...
source(paste0(scriptDir, "/ABM7.R")) #w. citation networks
```
...
replications <- 20 #100 originally, now 2. 
...
net_size <- 160 #changed for citation 
...
```{r}
net_types <- list("Citation", "Lattice", "Small") #"Lattice", "Small", "Citation
sigmas <- list(0.5) #0.2, 0.5, 0.8 
sampleSizes <- list(100) #20, 100. 
pop_types <- list("Bo") #"Bo", "Mave", "Tess", "All"
