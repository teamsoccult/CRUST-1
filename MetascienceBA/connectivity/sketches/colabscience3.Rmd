...
prop_list <- unlist(prop_m)
colab_mod <- sample(prop_list, size = 1) #not necessarily a colab mod. just the mod. 
...
if(colab == "yes"){ #maybe just no matter what. 
  ...
  deterministic_colab <- calculateDet(tModel, Xset_colab, weights, tModelBetas)
