...
networks <- FPTT_NO_NA(df_clean, network)
sigma <- FPTT_NO_NA(df_clean, sigma)
true_model <- FPTT_NO_NA(df_clean, true_model)
net_size <- FPTT_NO_NA(df_clean, net_size)
colab_cond <- FPTT_NO_NA(df_clean, colab_cond)
...
networks <- FPTT_OVERALL(df_NA, network)
sigma <- FPTT_OVERALL(df_NA, sigma)
true_model <- FPTT_OVERALL(df_NA, true_model)
net_size <- FPTT_OVERALL(df_NA, net_size)
colab_cond <- FPTT_OVERALL(df_NA, colab_cond)
