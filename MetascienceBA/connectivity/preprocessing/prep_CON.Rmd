...
violin_ridges_rework <- function(files){
  ...
  #write csv:
  write_csv(RR_TAT, paste0("violin_ridges_RR.csv", naming_scheme))
  write_csv(RR_TF, paste0("violin_ridges_TF.csv", naming_scheme))
  write_csv(RR_TF_BYSTRAT, paste0("violin_ridges_BYSTRAT.csv", naming_scheme))
...
subset_variables <- c("Lattice", "Small", "PT", "TOM") #or TOM
...
stickiness_rework <- function(files){
  ...
  #write csv:
  write_csv(df_final, paste0("stickiness_rework",
                             naming_scheme))
...
test <- read_csv("Lattice_All_0.2_BIC_413_hard_20_2_COLAB.csv")
...
TATC <- function(files){
  ...
  #write csv:
  write_csv(TAT_C_REP, paste0("TATC_REP.csv", naming_scheme))
  write_csv(TAT_C_AVG, paste0("TATC_AVG.csv", naming_scheme))
