...
#working directory 
setwd("~/CRUST-1/MetascienceBA/data")
...
TAT_MED <- medianFX(TAT_POP, population, TAT_median)
TAT50_MED <- medianFX(TAT50_POP, population, TAT50_median)
TATC_MED <- medianFX(TATC_POP, population, TAT_median)
STICK_MED <- medianFX(STICK_POP, population, stickiness_median)
RR_MED <- medianFX(RR_POP, population, RR_median)
RRT_MED <- medianFX(RR_TF_POP, population, RR_median)
...
#reusing the functon 
TAT_IQR <- medianFX(TAT_POP, population, TAT_IQR)
TAT50_IQR <- medianFX(TAT50_POP, population, TAT50_IQR)
TATC_IQR <- medianFX(TATC_POP, population, TAT_IQR)
STICK_IQR <- medianFX(STICK_POP, population, stickiness_IQR)
RR_IQR <- medianFX(RR_POP, population, RR_IQR)
RRT_IQR <- medianFX(RR_TF_POP, population, RR_IQR)
