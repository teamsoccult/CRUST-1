...
outputDirCsv <- paste0(baseDir, "/data/raw/csv")
outputDirRds <- paste0(baseDir, "/data/raw/rds")
```
...
source(paste0(scriptDir, "/modelSimilarByInteraction_TEST.R"))
source(paste0(scriptDir, "/modelSimilarByTerm_TEST.R"))
...
source(paste0(scriptDir, "/ABM_PT_CON.R")) #TOM cit. network. 
```
...
```{r}
net_types <- list("Small") #"Lattice", "Small", "PT"
...
colab_probs <- list(0) #no colab vs. colab. 
