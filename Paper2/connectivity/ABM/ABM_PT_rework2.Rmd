...
Now up to the changes made in the rework-session. New constants, fewer variables. This is the document for the PT-networks and 413-sized networks in general. 
...
source(paste0(scriptDir, "/ABM_PT_rework3.R")) #PT cit. network. 
```
...
replications <- 4 #100 originally, now 2. 
...
```{r}
net_types <- list("PT", "Small", "Lattice") #"Lattice", "Small", "PT"
sigmas <- list(0.5) #0.2, 0.5, 0.8 
base_sampleSizes <- list(20) #20, 100. 
pop_types <- list("Mave") #"Bo", "Mave", "Tess", "All"
tMods <- list(13) #2, 7, 13. 
modelCompares <- list(BIC) #AIC, BIC 
colab_probs <- list(0.02, 0) #no colab vs. colab. 
```
