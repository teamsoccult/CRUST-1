...
Parameters for the model comparison
...
sigmas = c(0.2, 0.5, 0.8) #if we wanted to add an estimation from psychology reports, we could add an extra sigma here. We would have to remember to change the sigma in the "noReplicator.R"-document
